...
const AUTHORITIES = [
  ...
  { short: "ISCIR", full: "Inspecția de Stat pentru Cazane, Recipiente sub Presiune și Instalații de Ridicat" },
  { short: "ISO", full: "Organizația Internațională de Standardizare" },
];
