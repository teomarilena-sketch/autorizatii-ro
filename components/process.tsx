...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    short: "Săpt. 4–12",
    detail:
      "Depunem dosarul la AFER, ANRE, IGPR, IGSU, AGFR sau ISCIR, urmărim termenele legale, răspundem la solicitările de completare și te asistăm la audit sau la evaluarea tehnică.",
    duration: "variabil",
  },
  {
    icon: Stamp,
