...
export const site = {
  ...
  description:
    "Consultanță pentru obținerea autorizațiilor și licențelor în România: AFER, IGPR, ISU, ANRE (energie și gaze), AGFR, ISCIR și certificări ISO. Proces digitalizat, un singur punct de contact.",
